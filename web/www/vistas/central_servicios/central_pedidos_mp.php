<?php
    ...
    $PageSection = "Central de pedidos de materia prima";
?>
  ...
  <div class="pagetitle">
    ...
    <nav>
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item">Central de pedidos de materia prima</li>
...
<?php 
  ...
  $id = 'central_pedidos_mp';
  $ButtonAddLabel = "Nuevo pedido";
