<?php
    ...
    $consultaselect = "SELECT ad.id_detalle_almacen, 
                      ...
                      WHERE 
                          ad.kid_estatus = 1 AND ad.kid_categoria = 22";
  ...
  <div class="pagetitle">
    ...
    <nav>
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item">Central de servicios</li>
...
<?php 
  ...
  $id = 'central_mp';
  $ButtonAddLabel = "";
  $titulos = ['ID','Almacén','Producto','Categoria','Cantidad','Peso','Medida de peso','Existencia','Fecha de creación'];
