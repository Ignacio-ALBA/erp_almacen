...
// Consulta y transforma correctamente
...
$resultado->execute();
$datosAlmacenes = $resultado->fetchAll(PDO::FETCH_ASSOC);

$almacenes = [];

foreach ($datosAlmacenes as $a) {
  $almacenes[] = [
    'valor' => (string)$a['id_almacen'],
    'text' => $a['almacen'],
    'pordefecto' => 0 // ⚠️ Asegura que siempre esté presente
  ];
}



// Define si el usuario es superadmin (seguro)
