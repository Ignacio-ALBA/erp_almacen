...
<?php 
  ...
  CreateModalForm(
    ...
    [
      ...
      CreateInput(['type'=>'text','maxlength'=>'13','id'=>'rfc','etiqueta'=>'RFC (Campo opcional)','class'=>'ValidateRFC']),
      ...
      CreateInput(['type'=>'number','maxlength'=>'10','id'=>'celular1','etiqueta'=>'Celular 1 (Proveedor)','class'=>'ValidateTelefono']),
      CreateInput(['type'=>'number','maxlength'=>'10','id'=>'celular2','etiqueta'=>'Celular 2 (Factura)','class'=>'ValidateTelefono']),
